...
class SpecialContact extends SpecialPage {
	function __construct() {
		...
		$output->addHTML('
                ...
                <br />
                <h4 style="margin:0px 30px 0px 30px;"><i class="fa fa-envelope"></i> Contact us</h4>
                <p class="justify" style="margin:0px 30px 0px 30px;"><br />Please use the contact form below if you have any questions or requests concerning our services. We will respond to your message within 24 hours. Alternatively call us on (01234) 567890.</p>
                			<fieldset>					
					 <div class="row">
